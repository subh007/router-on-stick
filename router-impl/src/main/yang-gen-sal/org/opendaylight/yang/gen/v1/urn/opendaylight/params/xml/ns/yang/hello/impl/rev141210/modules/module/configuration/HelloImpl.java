 ...
 * &lt;i&gt;hello-impl/modules/module/configuration/(urn:opendaylight:params:xml:ns:yang:hello:impl?revision=2014-12-10)hello-impl&lt;/i&gt;
 *
 */
public interface HelloImpl
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.hello.impl.rev141210.modules.module.configuration.HelloImpl>,
    Configuration
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.cachedReference(
        org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:hello:impl", "2014-12-10", "hello-impl"));
